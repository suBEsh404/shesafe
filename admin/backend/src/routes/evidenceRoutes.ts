...
import { uploadSchema, emergencySchema, emergencyFinalizeSchema, travelSchema, travelCheckpointSchema, idParamSchema, userParamSchema } from '../validators/evidenceValidators';
...
router.post('/emergency/finalize', authenticateOptional, validate(emergencyFinalizeSchema), evidenceController.emergencyFinalize);
